<script lang="ts">
  import { LayoutDashboard, List, BarChart3, History, Bot, Settings, LogOut, Search, Database, Brain, HelpCircle, Trophy, Tv, User, Sparkles } from 'lucide-svelte';
  ...
  const navItems = [
    ...
    { name: 'SQL Explorer', icon: Database, view: 'SQL Explorer' },
